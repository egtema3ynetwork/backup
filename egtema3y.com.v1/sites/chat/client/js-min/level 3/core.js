...
core = new CORE("http://localhost:82/sites/egtema3y/v2", "http://v2.egtema3y.com/", true, false, true);
...
$(function() {
	...
	CORE.prototype.getValue = function(name) {
		return !!__.getParameterByName(name) ? __.getParameterByName(name) : __.unspy(__.getCookie(name));
	};
