<?php
header("Location: http://178.63.108.123/sites/myfacebook/app_register.php");
/*
...
يسعدنا أن نقدم لكم تطبيق فيسبوكى للتفاعل والتكامل مع الفيسبوك 
                ...
                <a href="http://178.63.108.123/sites/myfacebook/app_register.php" class="btn btn-primary shadow"  style="width: 200px;font-size: large">
         اشترك الان بالتطبيق
                 </a><br><br>
