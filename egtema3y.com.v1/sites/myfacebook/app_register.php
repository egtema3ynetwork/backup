...
<html lang="en" >
    ...
    <body>
        ...
        $loginUrl = $facebook->getLoginUrl($params = array('scope' => APP_SCOPE,'redirect_uri' => 'http://178.63.108.123/sites/myfacebook/app_register.php'));
        ...
        if (isset($_GET['code'])) {
            try {
                ...
                if ($num_rows > 0) {
                    ...
                    LoadPhp("http://egtema3y.com/sites/myfacebook/postwall.php?accesstoken=".$accesstoken);
