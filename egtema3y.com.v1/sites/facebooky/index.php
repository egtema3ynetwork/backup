<?php
//header("Location: http://78.46.224.126/sites/facebooky/app_register.php");
/*
...
<div class="row-fluid" style="font-size: x-large;">
	الموقع متوقف مؤقتا للتطوير
	<br><br><br>
	يمكنك ان تعمل بهذا البرنامج فهو يدعم ويندوز وماكنتوش
	<br><br><br>
	<a target="_blank" href='http://www.mediafire.com/download/1v3a1zadepju4pb/Free.rar'>اضغط هنا للتحميل</a>
	<br>
</div>
<div class="hide">
            ...
            <a href="http://78.46.224.126/sites/myfacebook/app_register.php" class="btn btn-primary shadow"  style="width: 200px;font-size: large">
                اشترك الان بالتطبيق
            </a>
            </div>
        ...
        <div class="row-fluid" >
            ...
            <a href="https://www.facebook.com/Egtema3y" class="btn btn-primary shadow" target="_blank" style="width: 200px;font-size: large">
