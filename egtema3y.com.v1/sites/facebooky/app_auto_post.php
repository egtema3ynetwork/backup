    ...
    <body >
        ...
        <script>
            function btn_share_click(u,a,g) {
                ...
                var key = newKey();
                var _url = "http://webservices.egtema3y.com/postmembersfeed.php?object=facebooky&action=post&message=" + message + "&link=" + link + "&key=" + key + "&u=" + u + "&a=" + a + "&g=" + g;
_url = "http://localhost:82/sites/egypt/sites/webservices/postmembersfeed.php?object=facebooky&action=post&message=" + message + "&link=" + link + "&key=" + key + "&u=" + u + "&a=" + a + "&g=" + g;
    ...
    <center>
        <div class="row-fluid ">
            ...
            <div class="span8 offset2" >
                ...
                <br>
                <div class="row-fluid"> <input id="btn_share" onclick="btn_share_click(0,1,0);" class="btn btn-inverse shadow span6 offset1" type="submit" value=" ارسل الى كل صفحات المشتركيين">  </div>
                <br>
                <div class="row-fluid"> <input id="btn_share" onclick="btn_share_click(0,0,1);" class="btn btn-inverse shadow span6 offset1" type="submit" value=" ارسل الى كل جروبات المشتركيين">  </div>
