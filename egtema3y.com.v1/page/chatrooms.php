<html lang="en" xmlns:fb="http://ogp.me/ns/fb#">
    <head>
       <?php include("../content/start.php"); ?>
         ...
         <meta charset="utf-8">
    <title> شبكة إجتماعى  - غرف شات محمية بكلمة سر </title>
	<link rel="shortcut icon" type="image/x-icon" href="../img/rss.ico" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimum-scale=1.0, maximum-scale=1.0">
    <meta id="description" name="description" content="شات إجتماعى أول شات عربى مفتوح ومحمى بكلمة سر متعدد المستخدمين ويعمل على جميع انظمة التشغيل واجهزة الموبيل">
...
<link rel="image_src" href="../img/rss.ico"/>
    ...
    <body>
		...
		<div class="span9">
             <?php include("../script/chatroomsview.html"); ?> 
