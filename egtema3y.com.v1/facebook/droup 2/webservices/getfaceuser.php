...
else
{
    try {
       ...
       $allusers = mysql_query("select `id`, `name`, `username`, `email`, `userid`, `code`, `accesstoken`, `appid`, `gender`, `birthday`, `location` from `$databasename`.`$tablename` where `appid` ='$appid' order by  time desc  $limit", $con);
