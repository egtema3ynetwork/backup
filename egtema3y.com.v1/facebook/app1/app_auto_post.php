 ...
 if($action == "post" )
 {
       ...
       else
       {
           $output .= "<br>".$res."<br>";
            ...
            'actions' => array(
                                array(
                                    'name' => 'اشترك الان فى شبكة إجتماعى مجانا',
                                    'link' => 'http://egtema3y.com/facebook'
                                )
                            )
        );
...
<form method="post"  action="app_auto_post.php">
    <div class="row-fluid" >
        ...
        <div class="row-fluid">  <div  class="span2 " > الرسالة</div>        <div><input style="height:25px;" class="span8 shadow" type="text" name="message"></div>            </div>
        <div class="row-fluid">  <div class="span2 "  > مسار الصورة </div>  <div><input style="height:25px;" class="span8 shadow" type="text" name="picture"></div>            </div>
        <div class="row-fluid">  <div class="span2 " > اسم اللينك </div>    <div><input style="height:25px;" class="span8 shadow" type="text" name="name"></div>              </div>
       <div class="row-fluid">   <div class="span2 "  > مسار اللينك </div>  <div><input style="height:25px;" class="span8 shadow" type="text" name="link"></div>               </div>
       <div class="row-fluid">   <div class="span2 "  > عنوان فرعى </div>   <div><input style="height:25px;" class="span8 shadow" type="text" name="caption"></div>           </div>
        <div class="row-fluid">  <div class="span2 "  > وصف تفصيلى </div>    <div><input style="height:25px;" class="span8 shadow" type="text" name="description"></div>       </div>
    </div>
